...
pub fn layers(
    ...
    if let Some((color, count, spacing)) = m.ghosts {
        ...
        for k in (1..=count).rev() {
            ...
            if (matches!(cell, Cell::Uppercut(_) | Cell::UppercutCompact(_) | Cell::AirSaber(_) | Cell::AirLights(_) | Cell::CrouchSaber(_) | Cell::Flash(_) | Cell::Chant(_) | Cell::Signature(_) | Cell::StandingLights(_) | Cell::CrouchLights(_) | Cell::Utility(_) | Cell::AirRecovery(_) | Cell::Recoil(_) | Cell::Ground(_)) || kogan_combat_cell(f.id, cell)) && snap.cell != cell { continue; }
    ...
    if let Some(prev) = history.previous_cell(i, cell).filter(|prev| {
        !(cuts || [cell, prev.cell].into_iter().any(|c| {
            matches!(c, Cell::Uppercut(_) | Cell::UppercutCompact(_) | Cell::Movement(_) | Cell::Ranged(_) | Cell::AirSaber(_) | Cell::AirLights(_) | Cell::CrouchSaber(_) | Cell::Flash(_) | Cell::Chant(_) | Cell::Signature(_) | Cell::StandingLights(_) | Cell::CrouchLights(_) | Cell::Utility(_) | Cell::AirRecovery(_) | Cell::Recoil(_) | Cell::Ground(_) | Cell::Atlas(0..=3))
...
fn authored_drawing(id: CharacterId, cell: Cell) -> bool {
    matches!(cell, Cell::Reaction(_) | Cell::Uppercut(_) | Cell::UppercutCompact(_) | Cell::Movement(_) | Cell::Ranged(_) | Cell::AirSaber(_) | Cell::AirLights(_) | Cell::CrouchSaber(_) | Cell::Flash(_) | Cell::Chant(_) | Cell::Signature(_) | Cell::StandingLights(_) | Cell::CrouchLights(_) | Cell::Utility(_) | Cell::AirRecovery(_) | Cell::Recoil(_) | Cell::Ground(_) | Cell::Atlas(0..=3))
        || kogan_combat_cell(id, cell)
}

fn respect_authored_drawing(id: CharacterId, cell: Cell, m: &mut Motion) {
    if matches!(cell, Cell::AirSaber(_) | Cell::AirLights(_) | Cell::CrouchSaber(_) | Cell::Flash(_) | Cell::Chant(_) | Cell::Signature(_) | Cell::StandingLights(_) | Cell::CrouchLights(_)) || id == CharacterId::Kogan && matches!(cell, Cell::AirShot(_) | Cell::AirSaber(_) | Cell::AirLights(_) | Cell::Flash(_) | Cell::CrouchSaber(_) | Cell::CrouchPunch(_) | Cell::Overhead(_) | Cell::ThrowTech(_) | Cell::Victory(_)) {
